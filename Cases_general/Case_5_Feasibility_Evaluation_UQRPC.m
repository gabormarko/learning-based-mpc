% Feasibility evaluation of UQRMPC with different I_0^w
clc
clear
close all
load('parameters_FINAL_nx3_feas5.875_2.mat');
...
opts_ini_set.N_pre_sam = 10; % change this to 10, 100, 200, 500, 2000, 5000, corresponding to |I_0^w|
...
% Generalized initial state for LV and RM
x_LV_0 = zeros(nx,1);
x_LV_0(1) = 100;
if nx >= 2, x_LV_0(2) = 10; end
% For nx > 2, you can set additional elements as needed

x_RM_0 = zeros(nx,1);
x_RM_0(1) = min(V(:,1)) + 0.1;
if nx >= 2, x_RM_0(2) = max(V(:,2)) - 0.3; end
% For nx > 2, you can set additional elements as needed

x_EV_0 = x_LV_0 + x_des + x_RM_0;
N_MC = 100; % number of Monte-Carlo simulations of each |I_0^w|
...
for i = 1:1:N_MC
    ...
    % Generalized feasibility check for all state dimensions
    ...
    exceed_up_x = sum(State_RM_UQMPC > distance_error, 'all');
    exceed_low_x = sum(State_RM_UQMPC < -distance_error, 'all');
    index = length(exceed_up_control) + length(exceed_low_control) + exceed_up_x + exceed_low_x;
    if index~= 0
...
if opts_ini_set.N_pre_sam == 10
    ...
    save('Results_5_10_FINAL_nx3_feas5.875_2.mat', 'Results_5_10');
end
...
if opts_ini_set.N_pre_sam == 100
    ...
    save('Results_5_100_NEW.mat', 'Results_5_100');
end

if opts_ini_set.N_pre_sam == 200
    Results_5_200.x_RM_0 = x_RM_0;
    Results_5_200.N_pre_sam = opts_ini_set.N_pre_sam;
    Results_5_200.Control_EV =  Control_EV;
    Results_5_200.State_RM = State_RM;
    Results_5_200.Infeasible_Index = Infeasible_Index;
    save('Results_5_200_NEW.mat', 'Results_5_200');
end
...
if opts_ini_set.N_pre_sam == 500
    ...
    save('Results_5_500_NEW.mat', 'Results_5_500');
end
...
if opts_ini_set.N_pre_sam == 2000
    ...
    save('Results_5_2000_NEW.mat', 'Results_5_2000');
end
...
if opts_ini_set.N_pre_sam == 5000
    ...
    save('Results_5_5000_NEW.mat', 'Results_5_5000');
end
